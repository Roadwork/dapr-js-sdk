...
var DaprBinding = /** @class */ (function () {
    function DaprBinding(express, daprUrl) {
        ...
        this.express.post("/" + bindingName, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        e_1 = _a.sent();
                        return [2 /*return*/, res.status(HttpStatusCode_enum_1.default.INTERNAL_SERVER_ERROR).send(JSON.stringify({
                    ...
                    return [2 /*return*/, res.status(HttpStatusCode_enum_1.default.OK).send()];
                }
            });
        }); });
    };
