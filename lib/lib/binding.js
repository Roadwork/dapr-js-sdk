...
var DaprBinding = /** @class */ (function () {
    function DaprBinding(express, daprUrl, daprPort) {
    ...
    DaprBinding.prototype.receive = function (bindingName, cb) {
        ...
        this.express.use(express_1.default.json()); // Accept dapr format
        this.express.post("/" + bindingName, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, cb(req === null || req === void 0 ? void 0 : req.body)];
                    case 1:
                        _a.sent();
                        res.status(200).send();
                        return [2 /*return*/];
    ...
    DaprBinding.prototype.send = function (bindingName, data) {
        return __awaiter(this, void 0, void 0, function () {
            var req, json, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, node_fetch_1.default(this.urlDapr + "/bindings/" + bindingName, {
                            method: 'POST',
                            headers: {
