...
var DaprState = /** @class */ (function () {
    function DaprState(express, daprUrl, daprPort) {
    ...
    DaprState.prototype.save = function (storeName, stateObjects) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, node_fetch_1.default(this.urlDapr + "/state/" + storeName, {
                            method: 'POST',
    ...
    DaprState.prototype.get = function (storeName, key) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, node_fetch_1.default(this.urlDapr + "/state/" + storeName + "/" + key)];
                    case 1:
                        req = _b.sent();
                        _a = req.status;
                        switch (_a) {
