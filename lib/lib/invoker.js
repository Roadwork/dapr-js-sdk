...
var DaprInvoker = /** @class */ (function () {
    function DaprInvoker(express, daprUrl) {
                        ...
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                if (!res.writableEnded) {
                                    return [2 /*return*/, res.json({ closed: true })];
                                }
                                return [2 /*return*/];
                        }
                    });
    ...
    DaprInvoker.prototype.invoke = function (appId, methodName, data) {
        if (data === void 0) { data = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, node_fetch_1.default(this.daprUrl + "/invoke/" + appId + "/method/" + methodName, {
                            method: 'POST',
                            headers: {
