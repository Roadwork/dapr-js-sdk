        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        server = _b.sent();
                        server[expressMethod]("/" + methodName, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, cb(req, res)];
                                    case 1:
                                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, node_fetch_1.default(this.daprUrl + "/invoke/" + appId + "/method/" + methodName, fetchOptions)];
                    case 1:
                        res = _a.sent();
