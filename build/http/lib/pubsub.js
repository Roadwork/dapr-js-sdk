    ...
    DaprPubSub.prototype.publish = function (pubSubName, topic, body) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, node_fetch_1.default(this.daprUrl + "/publish/" + pubSubName + "/" + topic, {
                            method: 'POST',
                            headers: {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        server = _a.sent();
                        server.get('/dapr/subscribe', function (req, res) {
                        ...
                        server.post("/route-" + pubSubName + "-" + topic, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: 
