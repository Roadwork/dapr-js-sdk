...
var WebServerSingleton = /** @class */ (function () {
    /**
     * Private constructor to prevent direct construction calls
     */
    function WebServerSingleton() {
    }
    /**
    ...
    WebServerSingleton.getServer = function () {
        return __awaiter(this, void 0, void 0, function () {
            var server;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getInstance()];
                    case 1:
                        server = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        server = _a.sent();
                        return [2 /*return*/, server.serverAddress];
                }
            });
        });
    };
    WebServerSingleton.destroy = function () {
        return __awaiter(this, void 0, void 0, function () {
            var server;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.getInstance()];
                    case 1:
                        server = _a.sent();
